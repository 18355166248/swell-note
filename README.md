...
- 笔记搜索、选择、收藏，以及可写本地 Vault 中的真实 Markdown 新建与编辑；本地 Vault 与 WebDAV 工作副本支持跨笔记标签重命名，分别核对文件版本与缓存编辑序号
...
- 全局搜索可组合标题/正文范围、标签、目录、更新时间与收藏状态筛选，支持 `title:`、`tag:` 及对应的 `-title:`、`-tag:` 排除条件
