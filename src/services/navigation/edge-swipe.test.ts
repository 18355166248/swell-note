...
describe("shouldCompleteEdgeSwipe", () => {
  it("接受从左缘开始的快速右滑", () => {
    expect(shouldCompleteEdgeSwipe({ elapsedMs: 420, endX: 96, endY: 130, startX: 12, startY: 112 })).toBe(true)
  })
  ...
  it("拒绝纵向滚动和停留过久的手势", () => {
    ...
    expect(shouldCompleteEdgeSwipe({ elapsedMs: 900, endX: 100, endY: 100, startX: 8, startY: 100 })).toBe(false)
  })
})
